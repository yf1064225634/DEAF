...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear, DEAF
...
#验证
    def vali(self, vali_data, vali_loader, criterion):
        ...
        np.save('./Loss/' + 'vali_loss.npy', total_loss)
...
#训练
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            np.save('./Loss/' + 'train_loss.npy', train_loss)
...
#测试
    def test(self, setting, test=0):
        ...
        mae, mse, r2, rmse, mape, mspe, rse, corr = metric(preds, trues)
        print('mse:{}, mae:{}, r2:{},rmse:{}'.format(mse, mae, r2, rmse))
        f = open("result.txt", 'a')
        f.write(setting + "  \n")
        ...
        np.save(folder_path + 'metrics.npy', np.array([mae, mse, r2, rmse, mape, mspe, rse, corr]))
